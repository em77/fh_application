class AppsController < ApplicationController
  ...
  private
    ...
    def app_params
      params.permit(:first_name, :last_name, :mi, :dob, :age,
        ...
        :recommend_known_length, :tour_date,
        ...
        :employer_5, :eth_aa, :eth_asian, :eth_na, :eth_cauc, :eth_aa_ac,
        :eth_aa_other, :eth_aa_unknown, :eth_aa_na, :eth_cuban, :eth_mex,
        :eth_pr, :eth_dom, :eth_sa, :eth_ca,
        ...
        :work_type_4, :work_title_5, :work_type_5, :work_notes,
        ...
        :legal_history_detail, :bronx_or_manhattan,
